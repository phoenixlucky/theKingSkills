...
$skills = @(
    ...
    @{ Name="bug-hunt";              CatIcon="[I]"; Repo="https://github.com/anthropics/skills";                                                        Desc="复现并定位问题，给出最小修复和验证路径";                   Source="Reasonix 内置";    Stars=$null },
    @{ Name="code-review";           CatIcon="[K]"; Repo="https://github.com/anthropics/skills";                                                        Desc="审查代码变更，优先发现缺陷、回归和缺失测试";               Source="Reasonix 内置";    Stars=$null },
    @{ Name="frontend-polish";       CatIcon="[P]"; Repo="https://github.com/anthropics/skills";                                                        Desc="优化界面细节、响应式状态和视觉一致性";                     Source="Reasonix 内置";    Stars=$null },
    @{ Name="officecli";             CatIcon="[O]"; Repo="https://github.com/iOfficeAI/OfficeCLI";                                                      Desc="创建、分析和修改 Office 文档（Word/Excel/PPT），AI Agent 专用 CLI"; Source="iOfficeAI";        Stars="⭐ 7.2k" },
    @{ Name="release-notes";         CatIcon="[L]"; Repo="https://github.com/anthropics/skills";                                                        Desc="整理面向用户的发布说明和升级注意事项";                     Source="Reasonix 内置";    Stars=$null },
    @{ Name="docx";                  CatIcon="[W]"; Repo="https://github.com/thvroyal/kimi-skills";                                                    Desc="完整的 DOCX 文档创建、编辑与分析能力，支持修订、批注、格式保持和文本提取"; Source="kimi-skills";    Stars="⭐ 187" },
    @{ Name="pdf";                   CatIcon="[F]"; Repo="https://github.com/zavora-ai/skill-pdf-document-management";                                  Desc="专业 PDF 工具集：报告/海报/论文/简历生成，提取/合并/拆分/表单填写/格式转换"; Source="zavora-ai";      Stars="⭐ 1" }
)
